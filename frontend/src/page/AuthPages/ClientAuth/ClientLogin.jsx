          ...
          <div className="text-center mb-12">
            ...
            <div className="space-y-6 text-center">
              ...
              <p className="text-cyan-100 text-lg leading-relaxed max-w-md">
                Securely access appointments, records, and reminders with Medora.
              </p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 lg:px-12 py-12">
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600 text-lg">Sign in to your patient dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-2">
              <label className="flex items-center group cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-cyan-600 focus:ring-cyan-500/20 focus:ring-2" />
                <span className="ml-3 text-sm text-slate-600 group-hover:text-slate-800 transition-colors">Remember me</span>
              </label>
              <a href="#" className="text-sm text-cyan-600 hover:text-cyan-700 font-medium transition-colors hover:underline">Forgot password?</a>
            </div>
          ...
          <div className="my-8 flex items-center">
            ...
            <span className="px-4 text-xs text-slate-500 font-medium">PATIENT PORTAL</span>
            <div className="flex-1 border-t border-slate-300" />
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-slate-600">
              New patient?{" "}
              <a href="/client/register" className="text-cyan-600 hover:text-cyan-700 font-semibold transition-colors hover:underline">Create account</a>
            </p>
          </div>
