    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-start justify-center px-6 lg:px-12 py-12 overflow-y-auto h-screen">
        <div className="w-full max-w-2xl">
          <div className="mb-6">
            <button
              onClick={() => isVerificationStep ? setIsVerificationStep(false) : navigate(-1)}
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-slate-800 mb-2">
              {isVerificationStep ? "Verify Your Email" : "Create Your Patient Account"}
            </h2>
            <p className="text-slate-600 text-lg">
              {isVerificationStep ? `We\'ve sent a 6-digit code to ${formData.email}. Please enter it below.` : "Register to get started"}
            </p>
          </div>
