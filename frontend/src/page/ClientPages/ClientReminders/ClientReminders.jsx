...
const ClientReminders = () => {
  ...
  const stats = {
    ...
    today: 2, // Mock data for today's reminders
  };
          ...
          {reminders.map((reminder, index) => (
            ...
            >
              ...
              <div className="mt-auto">
                <button className="group w-full flex items-center justify-center px-4 py-3 bg-slate-100/80 backdrop-blur-sm text-slate-700 rounded-lg hover:bg-slate-200/80 hover:shadow-md hover:scale-105 transition-all duration-300 border border-slate-200/50">
