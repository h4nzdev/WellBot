        ...
        <header className="mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div className="mb-4 sm:mb-0">
              <h1 className="text-3xl md:text-4xl font-bold text-slate-800 tracking-tight">Medical Records</h1>
            ...
            <button className="group flex items-center justify-center px-6 py-3 bg-cyan-600/90 backdrop-blur-sm text-white rounded-xl shadow-lg hover:bg-cyan-700 hover:shadow-xl hover:scale-105 transition-all duration-300 w-full sm:w-auto border border-cyan-500/20">
              ...
              <span className="font-semibold tracking-wide">Download All Records</span>
            </button>
          </div>
        </header>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-slate-600 tracking-wide uppercase">{stat.title}</p>
          ...
          {records.map((record, index) => (
            ...
            >
              <div className="flex-grow">
                <p className="text-xl font-bold text-slate-800 tracking-tight">{record.doctor}</p>
                <p className="text-cyan-600 font-semibold text-sm tracking-wide uppercase mt-1">{record.date}</p>
                <div className="my-4 h-px bg-gradient-to-r from-slate-200 via-slate-300 to-slate-200"></div>
                <p className="text-slate-700 mb-4 font-medium leading-relaxed">{record.reason}</p>
              </div>
